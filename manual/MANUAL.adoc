...
If you're using mac, for now you'll need to grab our tarball.

curl -L "https://dl.bintray.com/thelastpickle/tlp-tools-tarball/tlp-stress-{TLP_STRESS_VERSION}.tar

...
You can find the default log4j config in https://github.com/thelastpickle/tlp-stress/tree/master/src/main/resources/log4j.yaml[`conf`, window="_blank"].  This should be suitable for most use cases.
...
The Debian package installs a basic configuration file to `/etc/tlp-stress/log4j.yaml`.

...
`tlp-stress` uses the https://logback.qos.ch/[Logback, window="_blank"] logging utility which is similar to https://en.wikipedia.org/wiki/Log4j[log4j, window="_blank"].
